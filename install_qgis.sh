...
sudo apt-get remove qgis python-qgis saga grass qgis-plugin-grass grass-doc
...
sudo apt-get install -y qgis python-qgis saga grass qgis-plugin-grass grass-doc
